      ...
      <div className='flex justify-center items-center  h-[90vh] '>
            <div className=' flex flex-col gap-4 justify-center'>
                ...
                <div className='flex gap-4'>
                    <Link className='primarybtn px-4 py-2 rounded-[7px] bg-white text-black' href="/user/signin">Sign In</Link>
                    <Link className='secondarybtn px-4 py-2 rounded-[8px]  border-2 border-white ' href="/user/signup">Sign Up</Link>
                </div>
            </div>
      </div>
    </>
